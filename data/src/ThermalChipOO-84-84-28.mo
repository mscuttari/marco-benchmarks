package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 84 "Number of volumesin the x direction";
      parameter Integer M = 84 "Number of volumesin the y direction";
      parameter Integer P = 28 "Number of volumesin the z direction";
