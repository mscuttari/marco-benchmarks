package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 114 "Number of volumesin the x direction";
      parameter Integer M = 114 "Number of volumesin the y direction";
      parameter Integer P = 38 "Number of volumesin the z direction";
