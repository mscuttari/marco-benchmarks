package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 393 "Number of volumesin the x direction";
      parameter Integer M = 393 "Number of volumesin the y direction";
      parameter Integer P = 131 "Number of volumesin the z direction";
