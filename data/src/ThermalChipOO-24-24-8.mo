package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 24 "Number of volumesin the x direction";
      parameter Integer M = 24 "Number of volumesin the y direction";
      parameter Integer P = 8 "Number of volumesin the z direction";
