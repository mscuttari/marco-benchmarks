package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 183 "Number of volumesin the x direction";
      parameter Integer M = 183 "Number of volumesin the y direction";
      parameter Integer P = 61 "Number of volumesin the z direction";
