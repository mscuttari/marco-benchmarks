package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 18 "Number of volumesin the x direction";
      parameter Integer M = 18 "Number of volumesin the y direction";
      parameter Integer P = 6 "Number of volumesin the z direction";
