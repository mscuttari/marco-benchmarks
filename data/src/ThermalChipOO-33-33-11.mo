package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 33 "Number of volumesin the x direction";
      parameter Integer M = 33 "Number of volumesin the y direction";
      parameter Integer P = 11 "Number of volumesin the z direction";
