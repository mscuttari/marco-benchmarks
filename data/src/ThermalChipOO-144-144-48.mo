package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 144 "Number of volumesin the x direction";
      parameter Integer M = 144 "Number of volumesin the y direction";
      parameter Integer P = 48 "Number of volumesin the z direction";
