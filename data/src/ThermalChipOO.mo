package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 15 "Number of volumesin the x direction";
      parameter Integer M = 15 "Number of volumesin the y direction";
      parameter Integer P = 5 "Number of volumesin the z direction";
