package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 39 "Number of volumesin the x direction";
      parameter Integer M = 39 "Number of volumesin the y direction";
      parameter Integer P = 13 "Number of volumesin the z direction";
