package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 312 "Number of volumesin the x direction";
      parameter Integer M = 312 "Number of volumesin the y direction";
      parameter Integer P = 104 "Number of volumesin the z direction";
    ...
    model ThermalChip4Cores "Thermal chip model built with OO with 4 simulated cores"
      ...
      PowerSource Qsource[4, 4, 2*Nr, 2*Nr] "Array of power sources, first two indeces are core and area";
    algorithm
    //Switching sequence
  ...
  package Test
    ...
    model ThermalChip4Cores
      extends Models.ThermalChip4Cores;
    annotation(
      experiment(StartTime = 0, StopTime = 0.6, Tolerance = 1e-9, Interval = 0.0001),
      __OpenModelica_simulationFlags(lv = "LOG_STATS", s = "dassl"));
    end ThermalChip4Cores;
