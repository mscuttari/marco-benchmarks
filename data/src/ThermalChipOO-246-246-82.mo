package ThermalChipOO
  ...
  port.T = T;
    ...
    partial model BaseThermalChip
      parameter Integer N = 246 "Number of volumesin the x direction";
      parameter Integer M = 246 "Number of volumesin the y direction";
      parameter Integer P = 82 "Number of volumesin the z direction";
